			...
			<table>
				<tbody>
					<tr>
						...
						<td><input type="text" name="itemName" value="${ITEM.itemName }" required="required" placeholder="Item Name"/></td>
					</tr>
					<tr>
						<td><label>Unit:</label></td>
						<td><input type="text" name="unit" value="${ITEM.unit }" required="required" placeholder="Eg 250 ml, 50 mg, 100 pcs"/></td>
					</tr>
					
					<tr>
					<td><label>Beginning Inventory:</label></td>
					<td><input type="number" name="beginningInventory" value="${ITEM.beginningInventory }" required="required" placeholder="Beginning Inventory"/></td>
					</tr>
					...
					<td><input type="date" name="dateOfExpiry" value="${ITEM.dateOfExpiry }" required="required" /></td>
					</tr>
